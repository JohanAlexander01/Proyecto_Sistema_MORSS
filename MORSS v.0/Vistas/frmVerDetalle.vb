...
Public Class frmVerDetalle
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        Try
            ...
            ' Solo validar número de fojas si fue encontrado
            If estado = "Encontrado" Then
                If txtNunFojas.Text.Trim() = "" Then
                    MessageBox.Show("Debe ingresar el número de fojas para los documentos encontrados.", "Validación", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    Exit Sub
                End If
